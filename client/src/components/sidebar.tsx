    ...
    >
        <div className='flex h-[100%] w-full flex-col justify-start'>
            <div className='z-50 flex min-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black'>
                <div className='text-xl font-bold text-neutral-800 dark:text-neutral-50'>
                    Stack'd
                </div>
            </div>
            {/* TEAM */}
            <div className='flex items-center gap-5 border-y-[1.5px] border-neutral-200 px-8 py-4 dark:border-neutral-700'>
